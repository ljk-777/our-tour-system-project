...
const edges = [
  ...
  // 北京中心区 <-> 西北高校/园区（补充桥接，打通北京内部路网）
  { from:7,   to:4,   dist:8000,  time:25, transport:'bus' },    // 北海公园 -> 颐和园
  { from:7,   to:121, dist:12000, time:35, transport:'subway' }, // 北海公园 -> 北京大学
  { from:20,  to:121, dist:8000,  time:25, transport:'subway' }, // 雍和宫 -> 北京大学
