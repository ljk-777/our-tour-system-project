...
export default function Auth() {
  ...
  return (
    <div
      ...
      style={{ background: '#f5f5f7', animation: 'authEnter 0.55s cubic-bezier(0.16,1,0.3,1) both' }}
    >
            ...
            {[['login', '登 录'], ['register', '注 册']].map(([val, label]) => (
              <button key={val}
                ...
                style={{
                  ...
                  boxShadow:  tab === val ? '0 1px 4px rgba(0,0,0,0.10)' : 'none',
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                style={{
                  background: '#f5f5f7',
                  border: `1px solid ${focusField === 'username' ? '#0071e3' : 'rgba(0,0,0,0.10)'}`,
                  color: '#1d1d1f',
                  boxShadow: focusField === 'username' ? '0 0 0 3px rgba(0,113,227,0.12)' : 'none',
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                style={{
                  background: '#f5f5f7',
                  border: `1px solid ${focusField === 'password' ? '#0071e3' : 'rgba(0,0,0,0.10)'}`,
                  color: '#1d1d1f',
                  boxShadow: focusField === 'password' ? '0 0 0 3px rgba(0,113,227,0.12)' : 'none',
                  transition: 'border-color 0.2s, box-shadow 0.2s',
                }}
              />
            </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {DEMO_USERS.map(u => (
              <button
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.background  = '#e8f1fc';
