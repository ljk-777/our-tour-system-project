...
export default function SpotCard({ spot, animDelay = 0 }) {
  ...
  return (
    <Link
      to={`/spots/${spot.id}`}
      className="block rounded-2xl overflow-hidden group animate-item-in glass-card"
      style={{
        animationDelay: `${animDelay}ms`,
        transition: 'box-shadow 0.28s cubic-bezier(0.4,0,0.2,1), transform 0.28s cubic-bezier(0.34,1.56,0.64,1), background 0.2s ease',
      }}
      onMouseEnter={e => {
        e.currentTarget.style.boxShadow = '0 16px 48px rgba(0,0,0,0.12), 0 1px 0 rgba(255,255,255,1) inset';
